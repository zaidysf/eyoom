            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-6 clearfix">
                        ...
                        <ul class="top-header-nav list-unstyled thn-end me-2 pe-4 border-end">
                    ...
                    <div class="col-lg-3 clearfix">
                        <div class="header-title-search d-none d-lg-block">
                            ...
                            <div class="input input-button mb-0">
                                <input type="text" name="stx" id="modal_sch_stx" class="sch_stx top-search" maxlength="20" placeholder="전체 게시판 검색">
                                <div class="button top-search"><input type="submit"><i class="fas fa-search"></i></div>
                            </div>
                            </form>
                        </div>
                    </div>
